  ...
  <div class="modal-wrapper">
      ...
      <div class="form-wrapper login">
        ...
        <form action="" class="form login">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="enrollemt no" value="">
          </div>
          <div class="input-field">
    ...
    <div class="signup-wrapper">
      <div class="collapsed-section">
        <div class="hide-section">
          <h2 class="collapsed-heading">New To SDBCT?</h2>
      ...
      <div class="form-wrapper signup hidden">
        ...
        <form action="registers" class="form login">
          ...
          <div class="input-field">
            <i class="fas fa-key"></i>
            <input type="text" placeholder="enrollement no" name=entrollementNo>
          </div>
